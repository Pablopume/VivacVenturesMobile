...
class SendFriendRequestUseCase @Inject constructor(private val repository: FriendsRepository){
    operator fun invoke(friendRequest: FriendRequest) = repository.sendFriendRequest(friendRequest)
}